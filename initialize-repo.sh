...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-demolab-autocert
echo     https://github.com/tfynes-pivotal/tap-gitops-demolab-autocert
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-demolab-autocert --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-demolab-autocert
git branch -M main
